...
# -*- coding: utf-8 -*-
"""
HardNet Evaluation Script

This script evaluates HardNet feature detection and descriptor descriptors and AdaLAM matching
...
# HardNet doesn't need cv2
import kornia
import kornia.feature as KF
# HardNet is from kornia.feature
...
def initialize_models(device, max_epipolar_distance=1.0):
    """Initialize HardNet feature extractor, AdaLAM matcher, and RANSAC."""
    # HardNet is both detector and descriptor
    hardnet = KF.HardNet(pretrained=True).eval().to(device)
...
def extract_and_match_features(image0, image1, models, device):
    ...
    for batch_idx in range(batch_size):
        with torch.inference_mode():
            ...
            # Extract features with HardNet
            lafs1, resps1, descs1 = hardnet(image0_gray[batch_idx : batch_idx + 1])
            lafs2, resps2, descs2 = hardnet(image1_gray[batch_idx : batch_idx + 1])
