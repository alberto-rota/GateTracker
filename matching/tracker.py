...
class TemporalTracker(nn.Module):
        ...
        with torch.no_grad():
            for start in range(0, N_total, chunk_size):
                ...
                if self.matcher.model.resampled_patch_size != 16:
                    ...
                    from utilities.tensor_utils import chw2embedding
    ...
    def training_step(
        ...
        """
        from matching.temporal_tracking_losses import compute_temporal_tracking_losses
        from matching.tracking_losses import _sample_query_grid
